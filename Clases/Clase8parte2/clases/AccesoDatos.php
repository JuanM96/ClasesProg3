...
class AccesoDatos
{
    ...
    private function __construct()
    {
        try {
            ...
            $this->_objetoPDO = new PDO('mysql:host=localhost;dbname=slimprueba;charset=utf8', 'root', '', array(PDO::ATTR_EMULATE_PREPARES => false,PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
